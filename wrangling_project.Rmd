...
author: "Brady Puckett and Jim  Rouse"
date: "10-13-2020"
...
avg_wpd_dataset <- wpd_dataset %>% 
  group_by(yearID) %>% 
  summarize(wpd_average = mean(wpd))
...
> ANS: This is the number of wins that a team "should" get given their specific payroll. 
...
```{r}
calculations <- mutate(calculations, expected_wins = (payroll * wpd_average)) 
calculations
```
...
> ANS:  The Oakland A's had the most efficient use of their money compared to the other teams in the MLB. This graph shows us the "wins above salary expectation" for every team in Major League Baseball. 
